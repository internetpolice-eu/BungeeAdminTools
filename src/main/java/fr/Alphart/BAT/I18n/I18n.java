...
public class I18n {
	 ...
	 * @return String
	 */
	public static String tr_(final String message, final String[] formatObject) {
		try {
	 ...
	 * @return String
	 */
	public static String tr_(final String message) {
		try {
	...
	/**
	 * Same as {@link #tr_(String, String[])} except it adds a prefix
	 * 
	 * @param message
	 * @param formatObject
	 * @return
	 */
	public static BaseComponent[] tr__(final String message, final String[] formatObject) {
		try {
			final MessageFormat mf = new MessageFormat(getString(message));
	 ...
	 * @return
	 */
	public static BaseComponent[] tr__(final String message) {
		try {
			// Replace the quote as the message formatter does
