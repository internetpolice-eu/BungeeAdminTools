...
public class MuteCommand extends CommandHandler {
    ...
    public static void handleMuteCommand(final BATCommand command, final boolean global, final boolean ipMute,
        ...
        checkArgument(!PermissionManager.isExemptFrom(Action.MUTE, target), tr_("isExempt"));

        checkArgument(!mute.isMute((ip == null) ? target : ip, server, false), tr_("alreadyMute"));
    ...
    public static void handleUnmuteCommand(final BATCommand command, final boolean global, final boolean ipUnmute,
        ...
        checkArgument(
            ...
            (IModule.ANY_SERVER.equals(server) ? I18n.tr_("notMutedAny", formatArgs) : ((ipUnmute) ? I18n.tr_("notMutedIP",
                formatArgs) : I18n.tr_("notMuted", formatArgs))));
