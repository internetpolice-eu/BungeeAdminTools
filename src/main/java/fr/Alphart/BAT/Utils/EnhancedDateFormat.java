...
public class EnhancedDateFormat{
	...
	public EnhancedDateFormat(final boolean litteralDate){
		...
		final String at = I18n.tr_("at");
		defaultDF = new SimpleDateFormat("dd-MM-yyyy '" + at + "' HH:mm");
		if(litteralDate){
			tdaDF = new SimpleDateFormat("'" + I18n.tr_("today").replace("'", "''") + " " + at + "' HH:mm");
			tmwDF = new SimpleDateFormat("'" + I18n.tr_("tomorrow").replace("'", "''") + " " + at + "' HH:mm");
			ydaDF = new SimpleDateFormat("'" + I18n.tr_("yesterday").replace("'", "''") + " " + at + "' HH:mm");
		}
	}
